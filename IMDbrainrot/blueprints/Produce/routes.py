...
from IMDbrainrot.forms import FilterProduceForm, AddProduceForm, BuyProduceForm, RestockProduceForm
from IMDbrainrot.models import Produce as ProduceModel, ProduceOrder
from IMDbrainrot.queries import insert_produce, get_produce_by_pk, Sell, \
...
def produce():
    ...
    if request.method == 'POST':
        produce = get_produce_by_filters(Genre=request.form.get('Genre'),
                                         Moviename=request.form.get('Moviename'),
                                         MainActor=request.form.get('MainActor'),
                                         farmer_name=request.form.get('sold_by'),
                                         BrainRotScore=request.form.get('BrainRotScore'))
