...
import re
from IMDbrainrot.queries import get_user_by_user_name, get_farmer_by_pk, get_customer_by_pk
from IMDbrainrot.utils.choices import ProduceItemChoices, ProduceCategoryChoices, UserTypeChoices, \
